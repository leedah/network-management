 ...
 */
@WebServlet(name = "GpsServlet", urlPatterns = {"/route"})
public class GpsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //if (option.equals("route")) {
            System.out.println("about to call gpsJSON");

            ArrayList<ArrayList<Double>> gpsRoute = GpsJSON.gpsRoute(user, startDate, endDate);
            String geoJSONtext = GpsJSON.getGeoJSON(gpsRoute);
