    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul id="active" class="nav navbar-nav side-nav">
                ...
                <li class="selected"><a href="accessPointsOptimal.jsp"><i class="fa fa-map-marker"></i> Optimal Access Points</a></li>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class ="col-md-3">
                                ...
                                <div class = "col-md-3">
                                    <br/>
                                    <input type="submit" class="btn btn-success" value="Find Optimal" onclick="jsOptimal()">
...
<script>
    ...
    function jsOptimal() {
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost:8081/accessPointsOptimal?user=" + user + "&start=" + startDate + "&end=" + endDate,
            data: {"user": user, "startDate": startDate, "endDate": endDate},
            dataType: "text",
            success: function (json) {
                alert("Optimize successful!");
                var geojson = JSON.parse(json);
                addOptimalAccessPoints(geojson);
